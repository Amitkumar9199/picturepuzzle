...
const lowtime=localStorage.getItem("lowtime");
const highmove=localStorage.getItem("highmove");
...
function resumetime()
{
    ...
    timer=setInterval(function(){
        ...
        document.getElementById("noofmoves").innerHTML=move; document.getElementById("besttime").innerHTML=lowtime; document.getElementById("bestmove").innerHTML=highmove;
...
function checkwin1()
{
    ...
    if(flag==0)
    ...
    else if(flag==1)
        {
            ...
            if(lowtime != null){
                if (time < lowtime) {
                    localStorage.setItem("lowtime", time);
            ...
            if(highmove != null){
                if (highmove >move) {
                    localStorage.setItem("highmove", move);      
                }
            }
            else{
                localStorage.setItem("highmove", move);
            ...
            document.getElementById("besttime").innerHTML=localStorage.getItem("lowtime"); document.getElementById("bestmove").innerHTML=localStorage.getItem("highmove");
