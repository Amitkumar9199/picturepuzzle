...
const lowtimef3=localStorage.getItem("lowtimef3");
const highmovef3=localStorage.getItem("highmovef3");
...
function resumetime()
{
    ...
    timer=setInterval(function(){
        ...
        document.getElementById("besttime").innerHTML=lowtimef3; document.getElementById("bestmove").innerHTML=highmovef3;
    },1000);
}
var challenge1;
function challenge()
...
function checkwin1()
{
    ...
    if(flag==0)
    ...
    else if(flag==1)
        {
            ...
            if(lowtimef3 != null){
                if (time < lowtimef3) {
                    localStorage.setItem("lowtimef3", time);
            ...
            if(highmovef3 != null){
                if (highmovef3 >move) {
                    localStorage.setItem("highmovef3", move);      
                }
            }
            else{
                localStorage.setItem("highmovef3", move);
            ...
            document.getElementById("printtime").innerHTML=time;
            document.getElementById("noofmoves").innerHTML=move;
            document.getElementById("besttime").innerHTML=localStorage.getItem("lowtimef3"); document.getElementById("bestmove").innerHTML=localStorage.getItem("highmovef3");
