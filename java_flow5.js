...
const lowtimeflow5=localStorage.getItem("lowtimeflow5");
const highmoveflow5=localStorage.getItem("highmoveflow5");
...
function resumetime()
{
    ...
    timer=setInterval(function(){
        ...
        document.getElementById("besttime").innerHTML=lowtimeflow5; document.getElementById("bestmove").innerHTML=highmoveflow5;
    },1000);
}
var challenge1;
function challenge()
...
function checkwin1()
{
    ...
    if(flag==0)
    ...
    else if(flag==1)
        {
            ...
            if(lowtimeflow5 != null){
                if (time < lowtimeflow5) {
                    localStorage.setItem("lowtimeflow5", time);
            ...
            if(highmoveflow5 != null){
                if (highmoveflow5 >move) {
                    localStorage.setItem("highmoveflow5", move);      
                }
            }
            else{
                localStorage.setItem("highmoveflow5", move);
            ...
            document.getElementById("printtime").innerHTML=time;
            document.getElementById("noofmoves").innerHTML=move;
            document.getElementById("besttime").innerHTML=localStorage.getItem("lowtimeflow5"); document.getElementById("bestmove").innerHTML=localStorage.getItem("highmoveflow5");
