...
const lowtimeflow5num=localStorage.getItem("lowtimeflow5num");
const highmoveflow5num=localStorage.getItem("highmoveflow5num");
...
function resumetime()
{
    ...
    timer=setInterval(function(){
        ...
        document.getElementById("besttime").innerHTML=lowtimeflow5num; document.getElementById("bestmove").innerHTML=highmoveflow5num;
    },1000);
}
var challenge1;
function challenge()
...
function checkwin1()
{
    ...
    if(flag==0)
    ...
    else if(flag==1)
        {
            ...
            if(lowtimeflow5num != null){
                if (time < lowtimeflow5num) {
                    localStorage.setItem("lowtimeflow5num", time);
            ...
            if(highmoveflow5num != null){
                if (highmoveflow5num >move) {
                    localStorage.setItem("highmoveflow5num", move);      
                }
            }
            else{
                localStorage.setItem("highmoveflow5num", move);
            ...
            document.getElementById("printtime").innerHTML=time;
            document.getElementById("noofmoves").innerHTML=move;
            document.getElementById("besttime").innerHTML=localStorage.getItem("lowtimeflow5num");
            document.getElementById("bestmove").innerHTML=localStorage.getItem("highmoveflow5num");
